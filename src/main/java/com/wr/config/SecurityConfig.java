...
import com.wr.auth.JWTAuthenticationEntryPoint;
import com.wr.auth.JWTAuthorizationFilter;
import com.wr.auth.handle.LogoutSuccessHandlerImpl;
...
//                permitAll() 不管登入,不登入 都能访问
                .antMatchers("/logReg/**","/logout","/druid/**").anonymous()
